...
if __name__ == '__main__':
    ...
    folder_path = '/data/qjw/ms-swift-main/test_data/TC'
    ...
    for file in file_list:
        ...
        #     continue
        data = []
        with open('/data/qjw/ms-swift-main/test_data/TC/'+file, 'r', encoding='utf-8') as fin:
            for line in fin:
        ...
        for per_data in tqdm(data):
            ...
            # print(new_datas)
            # break
        with open(f'/data/qjw/ms-swift-main/10000_base_result_new/{file[:-6]}-glm4base_72000.jsonl', 'w', encoding='utf8') as f:
